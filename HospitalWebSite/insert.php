...
<html>
	...
	<link rel="stylesheet" href="collapsible.css">
		<title>Eye Clinic-NL Hospital</title>
...
$sql = "INSERT INTO tbl_appointment (`Id`,`fldFName`,`fldLName`,`fldService`,`fldPhone`,`fldDate`,`fldTime`,`fldMessage`) VALUES ('0', '$fname', '$lname','$service', '$phone','$date','$time', '$message')";


if( mysqli_query($con, $sql))
{
	echo "<center/>","<br/>","<br/>","<br/>","<img src =logo5.png>","<br/>","<br/>","<h1>","Appointment Records Inserted","<br/>","<br/>","<br/>","<br/>";
